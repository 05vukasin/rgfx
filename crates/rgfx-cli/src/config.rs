...
use crate::cli::{ColorFidelity, DitherMode, RenderOpts, Renderer, Shading};
...
pub struct Settings {
    ...
    pub color: bool,
    /// Requested color fidelity seed, or `None` to follow the terminal's detected capability.
    ///
    /// Only the interactive image viewer honours this today (it clamps the fidelity to what the
    /// terminal supports); other viewers ignore it.
